...
class sql_SemanticKittiDataset(Dataset):
    def __init__(
        self,
        split,
        test_mode,
...
#             sc_results = results['proposal_results']
#             completion_tp_p = sum([x[0] for x in sc_results])
#             completion_fp_p = sum([x[1] for x in sc_results])
#             completion_fn_p = sum([x[2] for x in sc_results])
#             precision_p = completion_tp_p / (completion_tp_p + completion_fp_p)
#             recall_p = completion_tp_p / (completion_tp_p + completion_fn_p)
#             iou_p = completion_tp_p / \
#                     (completion_tp_p + completion_fp_p + completion_fn_p)

#             res_dic.update({
#                 "Proposal_Precision": precision_p,
#                 "Proposal_Recall": recall_p,
#                 "Proposal_IoU": iou_p,
#             })
