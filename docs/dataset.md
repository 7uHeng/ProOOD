...
These configs set `ood_flag=True` in the model head and use the corresponding OOD test datasets to compute uncertainty-based OOD detection metrics (AUROC, AUPR, FPR@95).